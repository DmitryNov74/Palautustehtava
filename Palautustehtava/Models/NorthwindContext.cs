...
namespace Palautustehtava.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Henkilot> Henkilots { get; set; } = null!;
        public virtual DbSet<Invoice> Invoices { get; set; } = null!;
        public virtual DbSet<Omat> Omats { get; set; } = null!;
        ...
        public virtual DbSet<Tunnit> Tunnits { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Henkilot>(entity =>
            {
                ...
                entity.Property(e => e.HenkiloId)
                    .ValueGeneratedOnAdd()
                    .HasColumnName("Henkilo_id");

                entity.Property(e => e.Nimi).HasMaxLength(50);

                entity.Property(e => e.Osoite).HasMaxLength(100);

                entity.Property(e => e.Sukunimi).HasMaxLength(100);
            });
            ...
            modelBuilder.Entity<Omat>(entity =>
            {
                entity.HasNoKey();
                ...
                entity.Property(e => e.OmatId)
                    .ValueGeneratedOnAdd()
                    .HasColumnName("Omat_id");
            });
            ...
            modelBuilder.Entity<TableTest>(entity =>
            {
                ...
                entity.Property(e => e.TestOne).HasColumnName("testOne");
            });
            ...
            modelBuilder.Entity<Tunnit>(entity =>
            {
                ...
                entity.Property(e => e.HenkiloId).HasColumnName("Henkilo_id");

                entity.Property(e => e.TunnitId)
                    .ValueGeneratedOnAdd()
                    .HasColumnName("Tunnit_id");

                entity.Property(e => e.TunnitMaara).HasColumnName("Tunnit_maara");
            });
